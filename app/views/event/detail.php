    ...
    <div class="split-layout">
        <div class="left-col">
            <img src="<?= BASEURL; ?>/img/event/<?= $data['event']['gambar']; ?>" 
                 alt="<?= $data['event']['nama_event']; ?>" 
                 class="shadow-sm" 
                 style="width: 100%; height: 400px; object-fit: cover; border-radius: 8px;">
            
            <a href="<?= BASEURL; ?>/event/checkout/<?= $data['event']['id_event']; ?>" class="btn btn-waste w-100 mt-3 fs-5 fw-bold">
                Daftar Sekarang (Gratis)
            </a>
        </div>
        
        <div class="right-col">
            <h2 class="mb-4 fw-bold"><?= $data['event']['nama_event']; ?></h2>
            ...
            <div class="mt-4">
                ...
                <div class="info-box-tgl" style="font-size: 2.5rem; line-height: bold;">
                    📅<?= $data['event']['tanggal_pelaksanaan']; ?>
                </div>
            </div>
        </div>
    </div>
